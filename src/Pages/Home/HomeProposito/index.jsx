    ...
    return(
        ...
        <section className="conteudoNP">
            <div className="areaTextoNP">
                <h2 className="h2CNP">
                    <span data-aos="fade-left" data-aos-delay="300" className="titulo-azulNP">Nosso </span><span data-aos="fade-top
                    " className="titulo-amareloNP"> Propósito</span>
                </h2>
                <h3 data-aos="fade-left" data-aos-delay="300" className="h3CNP">
                Nosso propósito como empresa, é ajudar e transformar a vida de pessoas.
                </h3>
            </div>
            <div className="containerNP">
                <div data-aos="fade-left" data-aos-delay="300" className="caixasMVV">
