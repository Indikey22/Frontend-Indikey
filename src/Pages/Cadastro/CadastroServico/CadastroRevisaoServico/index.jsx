...
function CadastroRevisaoServico() {
    return (
        <>
        <main  className="RevisaoCadastroServicos">   
            <Link to='/'>
                <Fade top>
                    <img src={logo} alt="logo indikey" className="logoTopo" />
                </Fade>
            </Link>       
            <article className="conteudoCadastroRevisaoServicos">
            <h1>Revisão</h1>
                <section id="formularioRevisaoServicos">
                    {/*  */}
                    <div className="revisaoServicosTopo">
                        <div>
                    ...
                    {/*  */}
                    <div className="revisaoServicosMeio">
                        <div>
                    ...
                    {/*  */}
                    <div className="revisaoServicosBaixo">
                        <div >
                    ...
                    <div className="revisaoServicosBaixo">
                        ...
                        <section className="botoes">
                            ...
                            <Link to='/InfoPessoalAutonomo'><div className="BtnProximo">Finalizar</div></Link>
                            </div>
                        </section>
                    </div>
                </section>
